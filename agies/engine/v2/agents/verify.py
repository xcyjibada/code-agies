...
from agies.engine.v2.agents.base import AgentResponse, BaseAgent, ToolResult
from agies.engine.v2.sast import confidence_from_severity
...
class VerifyAgent(BaseAgent):
    ...
    def _apply_sast(
        ...
        try:
            from agies.engine.v2.sast.matcher import get_matcher
