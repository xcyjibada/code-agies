...
from agies.engine.v2.runner import AgentCall, Runner
...
def _inject_boundary_candidates(state: ProjectState) -> None:
    ...
    from agies.engine.v2.sast.bound_checker import check_depth_guard
...
class Brain:
    ...
    def __init__(
        ...
        from agies.engine.v2.router import QuotaMonitor
